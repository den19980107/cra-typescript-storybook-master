(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./Store", "./Storage", "jwt-decode"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./Store"), require("./Storage"), require("jwt-decode"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Store, global.Storage, global.jwtDecode);
    global.undefined = mod.exports;
  }
})(this, function (exports, _Store, _Storage, _jwtDecode) {
  "use strict";
  ...
  const initial = async rawConfig => {
    ...
    const decoded = directLineOptions.token ? (0, _jwtDecode2.default)(directLineOptions.token) : {};
    config.botId = (decoded.botId || config.botId).toLowerCase();
    config.userId = decoded.userId || config.userId || _Storage2.default.getUserId() || randomUserID();
    ...
    directLineOptions.conversationId = decoded.conversationId || directLineOptions.conversationId || _Storage2.default.getConversationId() || '';
