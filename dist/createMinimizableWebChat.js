...
var minimizableWebChatRef = React.createRef();
var createMinimizableWebChat = function (rawConfig, container, callback) {
    if (!container) {
    ...
    Configuration.initial(rawConfig).then(function (config) {
        return ReactDOM.render(React.createElement(MinimizableWebChat, { ref: minimizableWebChatRef, config: config }), container, callback);
    });
    return __assign(__assign({}, WebChatAPI), { WebChatToggleStateObservable: WebChatToggleStateObservable,
...
var openWebChat = function () { return toggleWebChat(true); };
var closeWebChat = function () { return toggleWebChat(false); };
var startConversation = function () { return __awaiter(void 0, void 0, void 0, function () {
    var minimizableWebChat;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getRefObject(minimizableWebChatRef)];
            case 1:
                minimizableWebChat = _a.sent();
                minimizableWebChat.handleStartDirectLine();
                return [2 /*return*/];
        }
    });
}); };
var endConversation = function () { return __awaiter(void 0, void 0, void 0, function () {
    var minimizableWebChat;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getRefObject(minimizableWebChatRef)];
 ...
 */
var toggleWebChat = function (display) { return __awaiter(void 0, void 0, void 0, function () {
    var minimizableWebChat;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getRefObject(minimizableWebChatRef)];
...
var getMessageUnreadCount = function () {
